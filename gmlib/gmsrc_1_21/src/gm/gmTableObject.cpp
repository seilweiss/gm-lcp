...
bool gmTableObject::Trace(gmMachine * a_machine, gmGarbageCollector* a_gc, const int a_workLeftToDo, int& a_workDone)
{
  gmTableNode * curNode;
  int index;
...
gmTableNode* gmTableObject::GetNext(gmTableIterator& a_it)
{
  int index = a_it;
  if(index == IT_NULL)
  {
