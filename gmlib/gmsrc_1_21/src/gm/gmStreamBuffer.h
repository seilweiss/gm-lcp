...
public:
    ...
    virtual unsigned int Read(void* p_buffer, unsigned int p_n, bool p_swap = false);
    virtual unsigned int Write(const void* p_buffer, unsigned int p_n, bool p_swap = false);
